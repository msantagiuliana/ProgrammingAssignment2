...
makeCacheMatrix <- function(x = matrix()) {
	...
	m <- NULL
					...
					get <- function() x
					setinverse <- function(solve) m <<- solve # calculates the inverse of the matrix, caches the result
...
## cacheSolve
# This function calculates the inverse of the special "vector" created 
# with makeCacheMatrix. It first checks to see if the inverse has 
